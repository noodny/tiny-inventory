...
export const InventoryFindManySelectSchema: z.ZodType<Prisma.InventorySelect> = z.object({
...
export const InventoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    storeId: z.boolean().optional(),
    productId: z.boolean().optional(),
    quantity: z.boolean().optional(),
