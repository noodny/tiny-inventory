...
export const InventoryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.InventorySelect> = z.object({
...
export const InventoryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    storeId: z.boolean().optional(),
    productId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const InventoryFindFirstOrThrowSchema: z.ZodType<Prisma.InventoryFindFirstOrThrowArgs> = z.object({ select: InventoryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([InventoryOrderByWithRelationInputObjectSchema, InventoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryWhereInputObjectSchema.optional(), cursor: InventoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryScalarFieldEnumSchema, InventoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InventoryFindFirstOrThrowArgs>;

export const InventoryFindFirstOrThrowZodSchema = z.object({ select: InventoryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([InventoryOrderByWithRelationInputObjectSchema, InventoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryWhereInputObjectSchema.optional(), cursor: InventoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryScalarFieldEnumSchema, InventoryScalarFieldEnumSchema.array()]).optional() }).strict();